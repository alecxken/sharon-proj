...
<html style="font-size: 16px;">
 ...
 <link rel="stylesheet" href="{{asset('dist/css/AdminLTE.min.css')}}">
  ...
  <body class="u-body">
    <header class="u-clearfix u-grey-40 u-header u-header" id="sec-da4e"><div class="u-expanded-width u-palette-1-dark-1 u-shape u-shape-rectangle u-shape-1"></div><div class="u-social-icons u-spacing-10 u-text-body-alt-color u-social-icons-1">
...
<li class="u-nav-item"><a class="u-border-4 u-border-active-custom-color-3 u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-6 u-text-active-palette-5-light-3 u-text-hover-custom-color-3 u-text-palette-5-light-3" href="{{ url('/home') }}" style="padding: 10px 20px;"> {{ Auth::user()->name }}</a><div class="u-nav-popup"><ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2"><li class="u-nav-item"><a class="u-border-4 u-border-active-custom-color-3 u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-6 u-text-active-palette-5-light-3 u-text-hover-custom-color-3 u-text-palette-5-light-3" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" style="padding: 10px 20px;">Logout</a>
 ...
 @else
</li><li class="u-nav-item"><a class="u-border-4 u-border-active-custom-color-3 u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-6 u-text-active-palette-5-light-3 u-text-hover-custom-color-3 u-text-palette-5-light-3" href="{{ route('login') }}" style="padding: 10px 20px;">Login</a>
</li> @if (Route::has('register'))<li class="u-nav-item"><a class="u-border-4 u-border-active-custom-color-3 u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-6 u-text-active-palette-5-light-3 u-text-hover-custom-color-3 u-text-palette-5-light-3" href="{{ route('register') }}" style="padding: 10px 20px;">Register</a>
</li>     
                        @endif
                    @endauth  @endif
                    </ul>
